        ...
        <div className="footerCmp">
            <footer>
                ...
                <div className="footerGetInTouch">
                    <h1>Get in touch</h1>
                    <ul>
                        <p>Any questions? Let us know in store at BP 473 Complexe universitaire Surat Gujarat, or call us on (+91) 7621847052</p>
                ...
                <div className="paragraphFooter"><p>Copyright ©2023 All rights reserved</p>
                    <Link to='' >Savan Ghori</Link>
                    <Link to='' >Vivek Dhameliya</Link>
                    <Link to='' >Jupin Lathiya</Link>
                </div>
